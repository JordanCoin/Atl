...
| 5 | eBay | Collectibles/Toys | Any Buy It Now item |
| 6 | Walgreens | Health/Beauty | Any item |
| 7 | Nike | Shoes/Apparel | Any item |
| 8 | Kohls | Clothing | Any item |
| 9 | Macys | Home/Bed/Bath | Any item |
| 10 | Nordstrom | Clothing/Accessories | Any item |
...
| 15 | Walgreens | 3 | Health item, qty 3 |
...
| 25 | Nordstrom | 2 items (qty 1, 1) | Two different items |
...
## Known broken merchants (skip these)

- **Home Depot** — Akamai bot detection errors on every internal navigation
- **Costco** — Requires membership login for cart
- **Lowes** — Same Akamai issues as Home Depot

If any other merchant consistently errors after 2-3 attempts, skip it and move to the next. Don't waste time fighting bot detection.
